...
const LearnVault: React.FC<LearnVaultProps> = ({ onContentProcessed }) => {
    ...
    const handleAddToVault = async () => {
        ...
        try {
            ...
            if (activeTab === 'generate') {
                ...
                extractedText = await generateKnowledgeBase(topic);
                setTopic('');
            } else {
                ...
                extractedText = await processLearnVaultContent(files, links);
                setFiles([]);
                setLinks([]);
            }

            onContentProcessed(extractedText);
            setIsSuccess(true);
        } catch (err) {
        ...
        <div className="w-full h-full flex flex-col items-center justify-center p-4">
             <div className="w-full max-w-2xl text-center">
                <div className="flex justify-center items-center gap-3 mb-4">
                    ...
                    <h1 className="text-3xl font-bold text-gray-800 dark:text-white">My LearnVault</h1>
                </div>
                <p className="text-gray-600 dark:text-gray-400 mb-8 max-w-lg mx-auto">
                    Provide your knowledge to get an accurate learning guide. Upload all the content you want to learn from.
                </p>
                ...
                <div className="mt-8">
                    ...
                    >
                        {isLoading ? (
                            ...
                            activeTab === 'generate' ? 'Generate & Add to Vault' : 'Add to Vault'
                        )}
                    </button>
                </div>
                ...
                {isSuccess && (
                     <p className="mt-4 text-green-600 dark:text-green-400 font-medium animate-fade-in">
                        ✅ Notes saved successfully to your LearnVault.
                    </p>
                )}
                {error && (
