...
const SkillPath: React.FC = () => {
    ...
    const renderInputScreen = () => (
        <div className="w-full max-w-4xl mx-auto text-center flex flex-col items-center justify-center h-full p-4">
            ...
            <form onSubmit={handleSubmit} className="w-full space-y-6 bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700">
                ...
                <button type="submit" className="w-full px-8 py-4 bg-blue-500 text-white text-lg font-semibold rounded-lg shadow-md hover:bg-blue-600 disabled:bg-blue-300 transition-colors flex items-center justify-center gap-2">
    ...
    const renderLoadingScreen = () => (
         <div className="text-center flex flex-col items-center justify-center h-full">
            ...
            <p className="mt-4 text-lg font-medium text-gray-700 dark:text-gray-300">Building your personalized roadmap...</p>
        </div>
    );
