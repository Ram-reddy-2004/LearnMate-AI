...
const LearnGuide: React.FC<LearnGuideProps> = ({ knowledgeBase, onNavigateToVault }) => {
    ...
    if (state === 'loading') return <ModuleLoadingIndicator text="Building your learning path..." />;
    if (state === 'reexplaining') return <ModuleLoadingIndicator text="Simplifying the concept..." />;
